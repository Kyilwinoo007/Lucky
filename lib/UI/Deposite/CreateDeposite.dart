...
class CreateDeposite extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CreateDepositeState();
}

class _CreateDepositeState extends State<CreateDeposite> {
  ...
  void saveTransaction() async {
    ...
    var result = await model.saveTransaction(
        ...
        Transaction(
            ...
            transactionsType: Constants.DEPOSITE_TYPE,
