...
class BankTransferChart extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _BankTransferChartState();

}

class _BankTransferChartState extends State<BankTransferChart>{
  ...
  List<String> bankTransferTypeList = Constants.bankTransferTypeList;
  ...
  @override
  void initState() {
    _selectedType =  bankTransferTypeList[0];
    _typeDropDownMenuItems = getDropDownMenuItems(bankTransferTypeList);
